...
- **ตัวอักษร**: เปลี่ยนฟอนต์หลักเป็น **Kanit** เพื่อรองรับภาษาไทยได้ดียิ่งขึ้น
- **ตัวอักษร**: เปลี่ยนฟอนต์โลโก้ FinderHub เป็น **Geist**

### แก้ไข

- **Admin Modal**: แก้ไขปัญหาที่หน้าต่างจัดการสินค้าของผู้ดูแลระบบไม่ปิดอัตโนมัติหลังจากลบรายการ

### เปลี่ยนแปลง

- **UI/UX**: ปรับปรุงความสม่ำเสมอของฟอนต์ทั่วทั้งแอปพลิเคชัน

## [2.1.1] - 2025-11-24

### แก้ไข

- แก้ไขปัญหาการอัปโหลดซ้ำ
- แก้ไขปัญหาเซิร์ฟเวอร์ dev ล็อก
- ปรับปรุงการเข้าถึง (Accessibility)
- แก้ไขคำเตือน Source Map

## [2.1.0] - 2025-11-24

### เพิ่มเติม

- **การอัปโหลดรูปภาพ**: ออกแบบระบบอัปโหลดรูปภาพใหม่ (อัปโหลดภายหลัง, แสดงตัวอย่างทันที)
- **UI**: ปรับปรุง UI สำหรับการ์ดรายการและหน้าต่าง

## [2.0.0] - 2025-11-24

### เปลี่ยนแปลง

- ปรับโครงสร้างโปรเจกต์ครั้งใหญ่
>>>>>>> Stashed changes
