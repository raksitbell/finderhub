...
2.  [ส่วนประกอบหลัก](#ส่วนประกอบหลัก)
    ...
    - [กลยุทธ์การโหลด](#การโหลดข้อมูล)
    - [องค์ประกอบ UI ที่ใช้ร่วมกัน](#องค์ประกอบ-ui-ที่ใช้ร่วมกัน-shared-ui)
3.  [การจัดการสถานะ (State Management)](#การจัดการสถานะ-state-management)
4.  [ชั้นข้อมูลและ Supabase](#ชั้นข้อมูลและ-supabase)
5.  [สคริปต์และเครื่องมือ](#สคริปต์และเครื่องมือ)
...
2.  **ขั้นตอนที่ 2: การตรวจสอบ (`AddItemPreview`)**
