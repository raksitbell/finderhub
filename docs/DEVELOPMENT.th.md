...
1.  [🏗️ โครงสร้างโปรเจกต์](#project-structure)
2.  [🧩 ส่วนประกอบหลัก](#core-components)
    - [แดชบอร์ดผู้ดูแลระบบ](#admin-dashboard)
    - [มอดูลและวิซาร์ด](#modals-wizards)
    - [กลยุทธ์การโหลด](#loading-strategy)
    - [องค์ประกอบ UI ที่ใช้ร่วมกัน](#shared-ui)
3.  [🧠 การจัดการสถานะ (State Management)](#state-management)
4.  [💾 ชั้นข้อมูลและ Supabase](#data-layer)
5.  [🛠️ สคริปต์และเครื่องมือ](#scripts-tools)
6.  [🎨 การตกแต่งและระบบ UI](#ui-system)
7.  [📜 บันทึกการเปลี่ยนแปลง (Changelog)](#changelog)

---

## <a id="project-structure"></a>🏗️ โครงสร้างโปรเจกต์
...
## <a id="core-components"></a>🧩 ส่วนประกอบหลัก

### <a id="admin-dashboard"></a>🛡️ แดชบอร์ดผู้ดูแลระบบ
...
### <a id="modals-wizards"></a>🪄 มอดูลและวิซาร์ด
...
### <a id="shared-ui"></a>🧱 องค์ประกอบ UI ที่ใช้ร่วมกัน (Shared UI)
...
- **🔄 Background Refresh**: การรีเฟรชข้อมูลใน Admin Dashboard จะทำในเบื้องหลังพร้อมแสดงสถานะที่ตาราง (Table Loading) แทนการโหลดหน้าใหม่ทั้งหมด เพื่อประสบการณ์ที่ลื่นไหล
...
## <a id="state-management"></a>🧠 การจัดการสถานะ (State Management)
...
## <a id="data-layer"></a>💾 ชั้นข้อมูลและ Supabase
...
## <a id="scripts-tools"></a>🛠️ สคริปต์และเครื่องมือ
...
## <a id="ui-system"></a>🎨 การตกแต่งและระบบ UI
...
## <a id="changelog"></a>📜 บันทึกการเปลี่ยนแปลง (Changelog)
