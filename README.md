...
- [คู่มือการใช้ API](#-คู่มือการใช้-api)
...
ระบบมี RESTful API สำหรับการจัดการข้อมูลของหาย (Items) โดยสามารถดูรายละเอียดเต็มรูปแบบได้ที่ [API Documentation](./API.md)

| Endpoint         | Method   | Description                  | Auth Required |
| ---------------- | -------- | ---------------------------- | ------------- |
| `/api/items`     | `GET`    | ดึงข้อมูลรายการของหายทั้งหมด | No            |
| `/api/items`     | `POST`   | เพิ่มรายการของหายใหม่        | Yes           |
| `/api/items/:id` | `GET`    | ดึงข้อมูลรายการตาม ID        | No            |
| `/api/items/:id` | `PUT`    | อัปเดตข้อมูลรายการ           | Yes           |
| `/api/items/:id` | `DELETE` | ลบรายการ                     | Yes           |
